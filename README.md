...
**Enemigos**
- `E` - Enemigo normal (1 vida, velocidad 1x)
- `e` - Enemigo rápido (0.5 vida, velocidad 2x) - aparece en nivel 10+
- `H` - Enemigo pesado (3 vida, velocidad 0.5x) - aparece en nivel 20+
